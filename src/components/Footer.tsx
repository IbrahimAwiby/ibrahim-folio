  ...
  return (
    <footer className="relative py-16 bg-card border-t border-border overflow-hidden md:px-4">
      ...
      <div className="absolute overflow-hidden inset-0">
        <motion.div
          className="absolute top-10 left-10 w-32 h-32 md:w-48 md:h-48 bg-green-500/5 rounded-full blur-3xl"
        ...
        />
        <motion.div
          className="absolute bottom-10 right-10 w-28 h-28 md:w-40 md:h-40 bg-blue-500/5 rounded-full blur-3xl"
        ...
        />
        <motion.div
          className="absolute top-1/2 left-1/4 w-24 h-24 md:w-32 md:h-32 bg-purple-500/5 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.3, 1],
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 w-full max-w-4xl">
            ...
            >
              ...
              <motion.p
                ...
                whileHover={{ x: 5 }}
              >
                MERN Stack Developer building complete web applications with
                React, Node.js, Express, MongoDB, and PostgreSQL. Creating
                robust fullstack solutions that deliver results.
              </motion.p>
              <motion.a
          ...
          >
            ...
            >
              <motion.p
                ...
                whileHover={{ x: 5 }}
              >
                © 2025 Ibrahim Hassan. All rights reserved.
              </motion.p>
            </motion.div>
          ...
          <motion.div variants={itemVariants} className="text-center">
            ...
            >
              Built with React, Next.js, TypeScript, Node.js, Express, MongoDB,
              PostgreSQL, Prisma, and Tailwind CSS. Designed and developed with
          ...
          <motion.div
            className="absolute bottom-4 left-4 w-3 h-3 bg-green-500/20 rounded-full"
            animate={{
              y: [0, -10, 0],
              transition: {
                duration: 4,
          ...
          />
          <motion.div
            className="absolute top-4 right-4 w-2 h-2 bg-blue-500/20 rounded-full"
            animate={{
              y: [0, -8, 0],
              transition: {
                duration: 3,
          ...
          />
          <motion.div
            className="absolute top-8 left-1/4 w-1.5 h-1.5 bg-purple-500/20 rounded-full"
            animate={{
              y: [0, -6, 0],
              transition: {
                duration: 3.5,
