...
const services = [
  {
    ...
    description:
      "End-to-end web applications using React, Next.js, Node.js, Express, and modern databases with Prisma ORM.",
    features: [
  ...
  },
  {
    ...
    description:
      "Robust server-side solutions with Node.js, Express, and type-safe database operations using Prisma.",
    features: [
      "API Development",
  ...
  },
  {
    ...
    description:
      "Efficient database architecture with MongoDB for flexible data and PostgreSQL for relational data using Prisma ORM.",
    features: [
      "MongoDB Solutions",
      "PostgreSQL Design",
      "Prisma ORM Setup",
  ...
  },
  {
    ...
    description:
      "Modern, responsive web applications using React with TypeScript, hooks, Redux Toolkit, and modern patterns.",
    features: [
      "Custom Components",
      "State Management",
  ...
  },
  {
    ...
    description:
      "Seamless integration of RESTful APIs and third-party services with proper error handling and data validation.",
    features: [
      "REST API Design",
  ...
  },
  {
    ...
    description:
      "Complete MERN stack applications with MongoDB, Express, React, Node.js plus PostgreSQL for complex data needs.",
    features: [
      "MongoDB & Mongoose",
      "Express.js Backend",
      "React Frontend",
  ...
  return (
    <section id="services" className="py-20 bg-background relative md:px-4">
      ...
      <div className="absolute overflow-hidden inset-0">
        <motion.div
          className="absolute top-1/3 left-1/4 w-72 h-72 md:w-96 md:h-96 bg-green-500/5 rounded-full blur-3xl"
        ...
        />
        <motion.div
          className="absolute bottom-1/3 right-1/4 w-64 h-64 md:w-80 md:h-80 bg-blue-500/5 rounded-full blur-3xl"
        ...
        <div ref={ref}>
          ...
          <motion.div className="text-center mb-16" variants={itemVariants}>
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              Comprehensive MERN stack development services with PostgreSQL &
              Prisma for robust, scalable applications
            </motion.p>
          </motion.div>
            ...
            <Card className="max-w-4xl mx-auto p-8 glass-effect border-primary/20 shadow-glow relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <motion.p
                  ...
                  whileHover={{ opacity: 1 }}
                >
                  From frontend to backend, database to deployment - I'll help
                  you create a complete, production-ready application with the
                  MERN stack.
                </motion.p>
                ...
                >
                  <motion.a
                    href="#contact"
                    className="px-8 py-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-full font-semibold shadow-lg relative overflow-hidden group"
                    whileHover={{
                      scale: 1.05,
              ...
              {/* Floating elements */}
              <motion.div
                className="absolute top-4 right-4 w-8 h-8 bg-green-500/10 rounded-full"
                animate={{
                  y: [0, -10, 0],
                  scale: [1, 1.1, 1],
                }}
              ...
              />
              <motion.div
                className="absolute bottom-4 left-4 w-6 h-6 bg-blue-500/10 rounded-full"
                animate={{
                  y: [0, 10, 0],
                  scale: [1, 1.2, 1],
                }}
