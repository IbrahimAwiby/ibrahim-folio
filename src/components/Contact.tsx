  ...
  return (
    ...
    >
      ...
      <div className="absolute overflow-hidden inset-0">
        ...
        />
        <motion.div
          className="absolute bottom-1/3 right-1/4 w-56 h-56 md:w-80 md:h-80 bg-blue-500/5 rounded-full blur-3xl"
        ...
        <div ref={ref}>
          ...
          >
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              Have a project in mind? Let's discuss how we can build your next
              fullstack application together.
            </motion.p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto w-full">
              ...
              <Card className="p-6 md:p-8 glass-effect border-primary/20 shadow-glow h-full w-full max-w-full relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  >
                    ...
                    {/* MERN Stack Badge */}
                    <motion.div
                      className="flex items-center gap-3 md:gap-4 p-3 md:p-4 rounded-lg border border-green-500/20 bg-green-500/5 w-full"
                      whileHover={{ x: 5 }}
                    >
                      <motion.div
                        className="p-2 md:p-3 bg-gradient-to-br from-green-500 to-emerald-500 rounded-full flex-shrink-0"
                        animate={{
                          scale: [1, 1.1, 1],
                        }}
                        transition={{
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="font-medium text-green-600 dark:text-green-400 text-sm md:text-base">
                    ...
                    {/* Availability Status */}
                    <motion.div
                      className="flex items-center gap-3 md:gap-4 p-3 md:p-4 rounded-lg border border-blue-500/20 bg-blue-500/5 w-full"
                      whileHover={{ x: 5 }}
                    >
                      <motion.div
                        className="p-2 md:p-3 bg-blue-500/20 rounded-full flex-shrink-0"
                        animate={{
                          scale: [1, 1.1, 1],
                        }}
                        transition={{
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="font-medium text-blue-600 dark:text-blue-400 text-sm md:text-base">
                ...
                />
                <motion.div
                  className="absolute bottom-4 left-4 w-4 h-4 bg-blue-500/10 rounded-full"
                  animate={{
                    y: [0, 8, 0],
                    scale: [1, 1.3, 1],
                  }}
            ...
            <motion.div variants={slideInRight} className="w-full">
              <Card className="p-6 md:p-8 glass-effect border-primary/20 shadow-glow h-full w-full max-w-full relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    >
                      ...
                      >
                        <Button
                          ...
                          className="bg-gradient-to-r from-green-500 via-blue-500 to-purple-500 hover:opacity-90 transition-all py-4 md:py-6 px-8 text-base md:text-lg font-semibold relative overflow-hidden group min-w-[140px] shadow-lg"
                          size="lg"
                        >
                          <motion.div
                          ...
                          {/* Submit button glow */}
                          <motion.div
                            className="absolute inset-0 bg-gradient-to-r from-green-500 via-blue-500 to-purple-500 rounded-lg opacity-0 group-hover:opacity-100 blur-lg"
                  ...
                  >
                    <p className="text-xs md:text-sm text-muted-foreground text-center">
                      💡 Need a fullstack application? I specialize in MERN
                      stack with PostgreSQL & Prisma. Let's build something
                      amazing together!
                    </p>
                  </motion.div>
                </div>
                ...
                {/* Floating elements */}
                <motion.div
                  className="absolute top-4 left-4 w-5 h-5 bg-green-500/10 rounded-full"
                  animate={{
                    y: [0, -6, 0],
                    scale: [1, 1.1, 1],
                  }}
                ...
                />
                <motion.div
                  className="absolute bottom-4 right-4 w-3 h-3 bg-purple-500/10 rounded-full"
                  animate={{
                    y: [0, 6, 0],
                    scale: [1, 1.2, 1],
                  }}
